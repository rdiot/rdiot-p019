    ...
    public String getTemperature() throws JsonProcessingException {
        ...
        for (int i = 0; i < MAX_TIME; i++) {
         ...
         if ((j >= 40) && checkParity()) {
             ...
             SensorValue mySensorObject = new SensorValue();
             mySensorObject.name = "temperature";
             mySensorObject.value = c;
             
             ObjectMapper mapper = new ObjectMapper();

             String jsonString = mapper.writeValueAsString(mySensorObject);
             value = jsonString;
